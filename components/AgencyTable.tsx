...
const COLS: { key: keyof Row; label: string; num?: boolean; title?: string }[] = [
  ...
  { key: 'days_since_last', label: 'Days since publish', num: true, title: 'Days since the most recent flight date this agency has published. Publication lags flying: many agencies upload in batches.' },
];
