...
const CURATED: Row[] = [
  ...
  { agency: 'Metropolitan Police Department', state: 'DC', platform: 'Unknown', status: 'lead, not located', flights: '', first_flight: '', last_flight: '', url: '', notes: 'Publishes a UAS programme page; no per-flight log located.' },
  ...
  { agency: 'Any agency using Flock Safety transparency', state: '', platform: 'Flock Safety (flocksafety.com)', status: 'lead, not located', flights: '', first_flight: '', last_flight: '', url: 'https://transparency.flocksafety.com/', notes: 'Separate from Aerodome and behind a login. Mostly licence-plate reader data rather than drone flights.' },
