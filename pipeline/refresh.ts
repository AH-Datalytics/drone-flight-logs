...
export const STEPS: Step[] = [
  ...
  { name: 'dronesense', args: ['pipeline/dronesense/collect.ts'], note: 'additive; the dashboard shows a month, the API takes a range' },
  { name: 'brinc', args: ['pipeline/brinc/collect.ts'], note: 'additive; checked against the total the dashboard advertises' },
  { name: 'self-published', args: ['pipeline/selfpub/collect.ts'], note: 'agencies running their own ArcGIS service; re-read in full' },
  { name: 'locate new agencies', args: ['scripts/resolve-places.ts'], note: 'cached; only agencies without a point are looked up' },
  { name: 'watch unnamed dashboards', args: ['scripts/check-unnamed.ts'], note: 'reports any that have started publishing' },
