...
const rows: Row[] = [
  { agency_id: 'milwaukee-pd', display_name: 'Milwaukee Police Department', state: 'WI', org_type: 'law_enforcement', flight_count: 4562, total_hours: 980, first_flight: '2025-03-08', last_flight: '2026-08-23', days_since_last: 9 },
  { agency_id: 'aep', display_name: 'AEP Gen Shared Services Engineering', state: null, org_type: 'corporate_utility', flight_count: 1, total_hours: 0.2, first_flight: '2025-01-01', last_flight: '2025-01-01', days_since_last: 600 },
  { agency_id: 'tulsa-fire', display_name: 'Tulsa Fire Department', state: 'OK', org_type: 'fire_ems', flight_count: 66, total_hours: 12, first_flight: null, last_flight: null, days_since_last: null },
];
